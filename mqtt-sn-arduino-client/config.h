...
#define LORA_MY_NODE_ID 0x20 // Change to "0x2X" for each node to get a unique LoRa node ID
#define MQTT_SN_CLIENT_ID                                                                          \
    "arduino-01" // Change to "arduino-XX" for each node to get a unique MQTT-SN client ID
