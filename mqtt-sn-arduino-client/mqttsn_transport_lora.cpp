...
int mqttsn_transport_send(const uint8_t *buf, uint8_t len) {
    ...
    Serial.print(F(" dst=0x"));        Serial.print(MESH_ADDR_GATEWAY, HEX);
    Serial.print(F(" next_hop=0x"));   Serial.print(next_hop, HEX);
...
uint8_t mqttsn_transport_recv(uint8_t *buf, uint8_t buf_size, uint32_t timeout_ms) {
    ...
    do {
        ...
        if (ttl == 0) {
            Serial.println(F("[relay] TTL=0, drop")); continue;
        }
        ...
        Serial.print(F("[relay] route src=0x")); Serial.print(src, HEX);
        Serial.print(F(" dst=0x"));              Serial.print(dst, HEX);
        Serial.print(F(" next=0x"));             Serial.print(next_hop, HEX);
        Serial.print(F(" seq="));                Serial.print(seq);
        ...
        Serial.print(F("[relay] flood src=0x")); Serial.print(src, HEX);
        Serial.print(F(" seq="));                Serial.print(seq);
