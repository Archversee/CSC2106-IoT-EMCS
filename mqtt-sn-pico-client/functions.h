...
void mqtt_sn_publish_topic_id(struct udp_pcb *pcb, const ip_addr_t *gw_addr, u16_t gw_port, u16_t topic_id, const char *payload, int qos, uint16_t msg_id, bool is_retransmit);
