## logged from automated_chunk_test.uf2

The purpose of this test is to verify the automated chunking functionality of the MQTT-SN Pico client. The test ensures that large files are correctly divided into smaller chunks for transmission and reassembled accurately on the receiving end.
...
✓ PASS: CRC verified (seq=4000, 239 bytes)
